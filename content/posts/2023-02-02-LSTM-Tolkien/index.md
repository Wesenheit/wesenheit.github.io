...
In original notebook, the Keras library was used. This approach is based on duo Jax + [Haiku](https://dm-haiku.readthedocs.io/en/latest/) from DeepMind. 
We will try to distinguish between drug names and Tolkien characters 
using simple LSTM model, surprisingly it isn't as easy as one can think. If you want to challenge yourself, here is popular website with [great quiz](https://antidepressantsortolkien.vercel.app/).
...
There are few approaches we can use to preprocess data. One can replace each character by corresponding integer number which should be further preprocessed
either by one-hot encoding or embedding into high-dimensional space. Because we have only 26 characters we will follow original approach and one-hot encode our values.
...
<img src="LSTM_with_Haiku_26_0.png" class="invert-on-dark" alt="loss curve">
...
<img src="LSTM_with_Haiku_29_1.png" class="invert-on-dark" alt="confusion_matrix">
